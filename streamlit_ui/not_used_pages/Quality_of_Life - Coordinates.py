...
# Streamlit app
st.title("Enter coordinates of any city in the world and get the Quality of Life classification :exclamation:")
...
st.write("## Interactive map around coordinates provided:")
...
st.write("## Model Prediction and Quality of Life classification")
...
data = get_satellite_image(latitude, longitude)
